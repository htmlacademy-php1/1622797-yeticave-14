<main>
    ...
    <form class="form container <?= $classname; ?>" action="sign-up.php" method="post" autocomplete="off">
        ...
        <div class="form__item <?= $classname; ?>">
            ...
            <input id="name" type="text" name="first_name" placeholder="Введите имя" value="<?= get_post_val('first_name'); ?>">
            <span class=" form__error"><?= $errors['first_name'] ?? ""; ?></span>
        </div>
        <?php $classname = isset($errors['contact']) ? "form__item--invalid" : "" ?>
        <div class="form__item <?= $classname; ?>">
            <label for="message">Контактные данные <sup>*</sup></label>
            <textarea id="message" name="contact" placeholder="Напишите как с вами связаться" value="<?= get_post_val('contact'); ?>"></textarea>
