    ...
    <form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form__container-two">
            ...
            <div class="form__item <?= $classname; ?>">
                ...
                <select id="category" name="category_id">
                    ...
                    <?php foreach ($categories as $category) : ?>
                        <option value="<?= $category['id'] ?>" <?= ($category['id'] === get_post_val('category_id')) ? 'selected' : '' ?>>
        ...
        <div class="form__container-three">
            <div class="form__item form__item--small <?= $classname; ?>">
                ...
                <input id="lot-rate" type="text" name="begin_price" placeholder="0" value="<?= get_post_val('begin_price'); ?>">
            ...
            <div class="form__item <?= $classname; ?>">
                ...
                <input class="form__input-date" id="lot-date" type="text" name="date_completion" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?= get_post_val('date_completion'); ?>">
